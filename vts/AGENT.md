...
- Project: `~/valley-tech-support/field-kit/` (same tree as `~/Documents/valley-tech-support/`)
...
### 7. Single Grok account (2026-07-16)

Josh uses **one** paid Grok account on **`kraken`**. Do not require a separate Linux `vtech` Grok install. All VTS ops work stays under `~/valley-tech-support`.
