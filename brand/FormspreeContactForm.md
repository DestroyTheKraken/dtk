...
[Form Library](https://formspree.io/library/)
[Help Articles](https://help.formspree.io/sections/building-your-form/)
...
```html
<form action="https://formspree.io/f/xwvjdqdj" method="POST">
...
<script>
  ...
  formspree('initForm', { formElement: '#my-form', formId: 'xwvjdqdj' });
</script>
...
initForm({ formElement: '#my-form', formId: 'xwvjdqdj' });
```
...
function ContactForm() {
  const [state, handleSubmit] = useForm('xwvjdqdj');
